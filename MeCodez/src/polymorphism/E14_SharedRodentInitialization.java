...
class Rodent3 {
	...
	NonSharedMember m1 = new NonSharedMember("r1"), m2 = new NonSharedMember(
			"r2");
...
class Mouse3 extends Rodent3 {
	NonSharedMember m1 = new NonSharedMember("m1"), m2 = new NonSharedMember(
			"m2");
...
//	private SharedMember m;
	...
	NonSharedMember m1 = new NonSharedMember("g1"), m2 = new NonSharedMember(
			"g2");
...
//	private SharedMember m;
	NonSharedMember m1 = new NonSharedMember("h1"), m2 = new NonSharedMember(
			"h2");
...
public class E14_SharedRodentInitialization {
	public static void main(String args[]) {
		...
		Rodent3[] rodents = { new Hamster3(sm), new Gerbil3(sm),
				new Mouse3(sm), };
		for (Rodent3 r : rodents)
			r.dispose();
	}
} /*
 * Output: Shared member constructor Non shared member constructor r1 Non shared
 * member constructor r2 Rodent constructor Number of references 1 Polymorphism
 * 
 * 121 Non shared member constructor h1 Non shared member constructor h2 Hamster
 * constructor Non shared member constructor r1 Non shared member constructor r2
 * Rodent constructor Number of references 2 Non shared member constructor g1
 * Non shared member constructor g2 Gerbil constructor Non shared member
 * constructor r1 Non shared member constructor r2 Rodent constructor Number of
 * references 3 Non shared member constructor m1 Non shared member constructor
 * m2 Mouse constructor Disposing Hamster Disposing Gerbil Disposing Mouse
