...
/******************
 * Exercise 8 ***************** Create a base class with only a non-default
 * constructor, and a derived class with both a default (no-arg) and non-default
 * constructor. Call the base-class constructor in the derived-class
 * constructors.
 ***********************************************/
